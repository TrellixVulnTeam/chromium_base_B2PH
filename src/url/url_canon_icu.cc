...
#include "base/third_party/icu/source/common/unicode/ucnv.h"
#include "base/third_party/icu/source/common/unicode/ucnv_cb.h"
#include "base/third_party/icu/source/common/unicode/utypes.h"
...
void ICUCharsetConverter::ConvertFromUTF16(const base::char16* input,
  ...
  do {
    ...
    int required_capacity = ucnv_fromUChars(
        converter_, dest, dest_capacity, (const UChar*)input, input_len, &err);
